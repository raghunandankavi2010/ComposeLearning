...
fun Tooltip(
    ...
    if (expandedStates.currentState || expandedStates.targetState) {
        ...
        Popup(
            ...
            popupPositionProvider = CustomPopupPositionProvider(offset = offset),//DropdownMenuPositionProvider(offset, LocalDensity.current),
...
class CustomPopupPositionProvider(private val offset: DpOffset) : PopupPositionProvider {
    override fun calculatePosition(
       ...
       return IntOffset( windowSize.width/2, windowSize.height/2)
    }
